...
)
{
    ...
    v8::ScriptOrigin Origin(v8::String::NewFromUtf8(isolate, pathForDebug, v8::NewStringType::kNormal).ToLocalChecked(),
    ...
    v8::ScriptCompiler::Source Source(v8::String::NewFromUtf8(isolate, Code, v8::NewStringType::kNormal).ToLocalChecked(), Origin);
...
pesapi_value pesapi_execute_module(pesapi_env env, const char* path)
{
    auto context = v8impl::V8LocalContextFromPesapiEnv(env);
    auto isolate = context->GetIsolate();

    auto pathV8 = v8::String::NewFromUtf8(isolate, path == nullptr ? "" : path, v8::NewStringType::kNormal).ToLocalChecked();
    ...
    v8::MaybeLocal<v8::Module> mod = ResolveModule(context, pathV8, entryModule);
    if (mod.IsEmpty())
    {
        // TODO
        return nullptr;
    ...
    return v8impl::PesapiValueFromV8LocalValue(moduleChecked->GetModuleNamespace());
}
