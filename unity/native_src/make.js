    ...
    'ios': {
        'arm64': {
            ...
            hook: async function(CMAKE_BUILD_PATH, OUTPUT_PATH, options) {
                ...
                sx.cp(`${CMAKE_BUILD_PATH}/${options.config}-iphoneos/*`, OUTPUT_PATH)
        ...
        'x64': {
            ...
            hook: async function(CMAKE_BUILD_PATH, OUTPUT_PATH, options) {
                ...
                if (options.config != 'Release') {
                    ...
                    sx.cp(`${CMAKE_BUILD_PATH}/${options.config}/*`, '../general/vs2013/Bin')
                }
                
                sx.cp(`${CMAKE_BUILD_PATH}/${options.config}/*`, OUTPUT_PATH)
        ...
        'arm64': {
            ...
            hook: async function(CMAKE_BUILD_PATH, OUTPUT_PATH, options) {
                ...
                if (options.config != 'Release') {
                    ...
                    sx.cp(`${CMAKE_BUILD_PATH}/${options.config}/*`, '../general/vs2022/Bin')
                }
                sx.cp(`${CMAKE_BUILD_PATH}/${options.config}/*`, OUTPUT_PATH)
            }
        }
