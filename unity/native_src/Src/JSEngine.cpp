...
namespace puerts
{
    ...
    JSEngine::JSEngine(void* external_context)
    {
...
#if WITH_QUICKJS
            Context = v8::Context::New(Isolate, external_context);
#else
            Context = *(v8::Local<v8::Context> *)external_context;
#endif
            MainIsolate = Context->GetIsolate();
        }
        v8::Context::Scope ContextScope(Context);
