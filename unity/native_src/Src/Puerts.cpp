...
{
    auto JsEngine = new JSEngine(nullptr);
    return JsEngine->MainIsolate;
}

V8_EXPORT v8::Isolate *CreateJSEngineWithExternalEnv(void* external_quickjs_context)
{
#if WITH_QUICKJS
    auto JsEngine = new JSEngine(external_quickjs_context);
    return JsEngine->MainIsolate;
#else
    return nullptr;
#endif
