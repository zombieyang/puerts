...
typedef void (*CSharpFunctionCallback)(v8::Isolate* Isolate, v8::Puerts::CSharpToJsValue* value, const v8::Puerts::FunctionCallbackInfo& Info, void* Self, int ParamLen, int64_t UserData);
